...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PD14     ------> ADC3_IN11
    */
    GPIO_InitStruct.Pin = TCRT1_Pin|TCRT2_Pin|TCRT3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TCRT4_Pin|TCRT5_Pin|TCRT6_Pin|TCRT7_Pin
                          |TCRT8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PD14     ------> ADC3_IN11
    */
    HAL_GPIO_DeInit(GPIOE, TCRT1_Pin|TCRT2_Pin|TCRT3_Pin);

    HAL_GPIO_DeInit(GPIOD, TCRT4_Pin|TCRT5_Pin|TCRT6_Pin|TCRT7_Pin
                          |TCRT8_Pin);
